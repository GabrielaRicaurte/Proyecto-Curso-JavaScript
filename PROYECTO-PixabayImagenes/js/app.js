...
function mostrarAlerta(mensaje) {
    ...
    if(!existeAlerta) {
        ...
        alerta.classList.add('bg-red-100', 'border-red-400', 'text-red-700', 'px-4', 'py-3', 'rounded', 'max-w-lg', 'mx-auto', 'my-6', 'text-center');
        alerta.innerHTML = `
...
function buscarImagenes() {
    ...
    const key = '23422427-239212e5c82c0fa7da6957ffc';
...
function mostrarImagenes(imagenes) {
    ...
    imagenes.forEach(imagen => {
        ...
        /* 
            _blank te abre una nueva pestaña con el enlace
            las etiquetas <a></a> son de tipo inline, para que funcione el my y el w-full es necesario colocarle block
         */
    });
